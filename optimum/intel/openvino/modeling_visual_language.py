...
# Qwen3.5 VLM - inherits from Qwen3_5Model for get_rope_index, get_placeholder_mask, get_vision_position_ids
# and from Qwen3_5VisionModel for rot_pos_emb, fast_pos_embed_interpolate
class _OVQwen35ForCausalLM(OVModelForVisualCausalLM, Qwen3_5Model, Qwen3_5VisionModel):
    additional_parts = ["vision_embeddings_merger", "vision_embeddings_pos"]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._rotary_pos_emb = Qwen3_5VisionRotaryEmbedding(
            self.config.vision_config.hidden_size // self.config.vision_config.num_heads // 2
        )
        self.num_grid_per_side = int(config.vision_config.num_position_embeddings**0.5)
        self.spatial_merge_size = config.vision_config.spatial_merge_size
    ...
    # Uses self.vision_embeddings_pos (OV model) instead of self.pos_embed (nn.Embedding)
    def fast_pos_embed_interpolate(self, grid_thw):
        grid_ts, grid_hs, grid_ws = grid_thw[:, 0], grid_thw[:, 1], grid_thw[:, 2]
    ...
    def get_video_features(
        ...
        video_embeds = torch.from_numpy(video_embeds)
...
MODEL_TYPE_TO_CLS_MAPPING = {
    ...
    "qwen3_5": _OVQwen35ForCausalLM,
    "qwen3_5_moe": _OVQwen35ForCausalLM,
