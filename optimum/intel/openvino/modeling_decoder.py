        ...
        **kwargs,
        ...
        if self.use_cache:
            ...
            if cache_position[0] > 0:
                ...
                if self.config.model_type not in ["lfm2", "granitemoehybrid", "qwen3_5_text", "qwen3_5_moe_text"]:
                    # LFM2, GraniteMoeHybrid (Granite-4.0) and Qwen3.5 hybrid models require the attention mask
